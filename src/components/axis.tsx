...
const TimelineAxis = ({ startDate, totalDays, dayWidth }: { startDate: string, totalDays: number, dayWidth: number }) => {
	...
	for (let day = 0; day <= totalDays; day++) {
		...
		if (day === totalDays) {
			...
			months.push({
				month: currentMonthStart ? format(currentMonthStart, monthFormat) : null,
				position: currentPosition,
	...
	return (
		<div className="timeline-axis o" style={{ width: `${totalDays * dayWidth}px` }}>
			{showMonthLabels && (
